COMPONENT_NAME = PulseTransportCoapsZephyr
...
SRC_FILES = \
	../ports/zephyr/pulse_transport_coaps.c \
	$(LIBMCU_ROOT)/modules/common/src/base64.c \

TEST_SRC_FILES = \
	src/pulse_transport_coaps_zephyr_test.cpp \
	src/test_all.cpp \
	mocks/zephyr_mock.cpp \
	mocks/zephyr_coap_mock.cpp \
